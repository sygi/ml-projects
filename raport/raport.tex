...
To choose optimal value of $\lambda$, we used 10-fold cross-validation. We tested $200$ candidates in logspace between $10^{-2}$ to $10^2$. Figure [fig. here] shows the result: optimal lambda was $\lambda = 0.8$ with test error around $x$
\end{subsubsection}
