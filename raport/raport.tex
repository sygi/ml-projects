...
\subfigure[Prediction of output variable based only on $9$-th input variable.]{\includegraphics[width=2.5in]{../figures/classif/gd-prediction-crop.pdf} \label{fig:gdPrediction}}
\hfill
\subfigure[Gradient norm in unpenalized gradient descent. Algorithm does not converge.]{\includegraphics[width=2.5in]{../figures/classif/gradient9-crop.pdf} \label{fig:gdGradient}}
\caption{}
\end{figure}
\end{subsubsection}
...
\subfigure[Train and test error of ridge regression without transformations for different value of $\lambda$]{\includegraphics[width=2.5in]{../figures/classif/lambda-crop.pdf} \label{fig:lambda}}
\hfill
...
\hfill
\subfigure[Correlation of input variables with the output variable]{\includegraphics[width=2.5in]{../figures/classif/boxplot_after-crop.pdf} \label{fig:correlation}}
\caption{}
\end{figure}
...
\begin{subsection}{Data analysis}
We took a look at the correlation between input variables, and there was not much correlation. More interesting was correlation of each input variable with the output one, which is shown on the figure \ref{fig:correlation}
\end{subsection}
