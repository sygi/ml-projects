...
\hfill
\subfigure[Correlation of input variables with the output variable]{\includegraphics[width=2.5in]{../figures/correlation-crop.pdf} \label{fig:correlation}}
\caption{}
\end{figure}
...
\hfill
\subfigure[TODO]{\includegraphics[width=2.5in]{../figures/correlation-crop.pdf} \label{fig:correlation}}
\caption{}
\end{figure}
\end{subsection}
